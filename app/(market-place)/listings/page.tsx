...
export default function ListingsPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ═══ Hero header ═══ */}
      <div className="relative overflow-hidden border-b border-border-primary bg-[#0d0c0a]">
        {/* Subtle radial glow */}
        ...
        <div className="relative pb-6 pt-10">
          ...
          <p className="mt-2 max-w-lg text-sm text-text-muted">
            Explore verified listings with blockchain-backed ownership certificates. 
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2 py-3">
            ...
            <div className="relative">
              <select
                value={sort}
                onChange={(e) => { setSort(e.target.value as NonNullable<ListingFilters['sort']>); setPage(1); }}
                className={cn(selectCls, 'appearance-none pr-8')}
              >
          ...
          {showFilters && (
            <div className="border-t border-border-secondary pb-3 pt-3">
              <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-6">
                <div className="relative">
                  <select value={category} onChange={(e) => { setCategory(e.target.value as typeof category); setPage(1); }} className={cn(selectCls, 'w-full appearance-none pr-8')}>
                ...
                <div className="relative">
                  <select value={propertyType} onChange={(e) => { setPropertyType(e.target.value); setPage(1); }} className={cn(selectCls, 'w-full appearance-none pr-8')}>
                ...
                <input type="number" min={0} value={minPrice} onChange={(e) => { setMinPrice(e.target.value); setPage(1); }} placeholder="Min price" className={fieldCls} />
                <input type="number" min={0} value={maxPrice} onChange={(e) => { setMaxPrice(e.target.value); setPage(1); }} placeholder="Max price" className={fieldCls} />
                <div className="relative">
                  <select value={minBeds} onChange={(e) => { setMinBeds(e.target.value); setPage(1); }} className={cn(selectCls, 'w-full appearance-none pr-8')}>
                ...
                <div className="relative">
                  <select value={minBaths} onChange={(e) => { setMinBaths(e.target.value); setPage(1); }} className={cn(selectCls, 'w-full appearance-none pr-8')}>
      ...
      <div className="py-8">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-border-primary bg-surface-card py-20">
            ...
            <p className="mt-4 text-lg font-semibold text-white">No properties found</p>
