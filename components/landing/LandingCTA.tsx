        ...
        <div className="cert grain relative overflow-hidden rounded-2xl px-8 py-14 text-center md:px-16">
          <div className="relative z-[2]">
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-[#5a4a2e] md:text-base">
              {isTenant
                ? 'Browse verified listings, save searches, apply for rentals, submit offers, and track lease activity from one marketplace account.'
                : 'Explore verified listings, submit your own property, prepare ownership documents for review, and transact through transparent title and escrow workflows.'}
            </p>
            ...
            <p className="mt-4 font-mono text-[10px] uppercase tracking-[0.2em] text-[#9d6f22]">
              Map discovery - KYC review - Digital title records - Lease escrow
            </p>
          </div>
        </div>
      </Reveal>
