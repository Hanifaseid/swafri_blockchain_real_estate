    ...
    <div className="grid gap-6">
      ...
      <div className="grid gap-3 rounded-xl border border-gray-200 bg-white p-4">
        {AVAILABLE_AMENITIES.map((amenity) => (
          <label
            key={amenity.id}
            className="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 transition hover:border-emerald-300 hover:bg-emerald-50/60"
          >
            <input
              type="checkbox"
              value={amenity.id}
      ...
      <FormField
        ...
        hint="Add any additional amenities not listed above."
      >
        <input
          type="text"
          placeholder="e.g. sauna, concierge"
